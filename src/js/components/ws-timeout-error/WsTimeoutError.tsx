...
class WsTimeoutError extends Component<WsTimeoutErrorProps> {
    render() {
        return (<Modal show={true} onHide={onHide(this.props.closable, this.props.dispatch)}>
            <Modal.Header closeButton={this.props.closable}>
                <Modal.Title className='text-warning'>Wolne połączenie internetowe.</Modal.Title>
            </Modal.Header>

            <Modal.Body className='text-warning'>
                <p>Proszę sprawdzić połączenie z internetem i spróbować jeszcze raz.</p>
            </Modal.Body>
